...
#ifndef MARKET_MATCHING_TRADING_SERVER_CPP_OPT_LOGGING_H
#define MARKET_MATCHING_TRADING_SERVER_CPP_OPT_LOGGING_H
...
#endif //MARKET_MATCHING_TRADING_SERVER_CPP_OPT_LOGGING_H
