...
#ifndef MARKET_MATCHING_TRADING_SERVER_CPP_TCP_SOCKET_H
#define MARKET_MATCHING_TRADING_SERVER_CPP_TCP_SOCKET_H
...
#endif //MARKET_MATCHING_TRADING_SERVER_CPP_TCP_SOCKET_H
