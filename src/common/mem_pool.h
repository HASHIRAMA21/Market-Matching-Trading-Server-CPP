...
#ifndef MARKET_MATCHING_TRADING_SERVER_CPP_MEM_POOL_H
#define MARKET_MATCHING_TRADING_SERVER_CPP_MEM_POOL_H
...
#endif //MARKET_MATCHING_TRADING_SERVER_CPP_MEM_POOL_H
