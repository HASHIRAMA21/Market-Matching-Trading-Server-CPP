...
//
#ifndef MARKET_MATCHING_TRADING_SERVER_CPP_LF_QUEUE_H
#define MARKET_MATCHING_TRADING_SERVER_CPP_LF_QUEUE_H
...
#endif //MARKET_MATCHING_TRADING_SERVER_CPP_LF_QUEUE_H
