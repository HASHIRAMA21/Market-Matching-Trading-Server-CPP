...
#ifndef MARKET_MATCHING_TRADING_SERVER_CPP_MARKET_UPDATE_H
#define MARKET_MATCHING_TRADING_SERVER_CPP_MARKET_UPDATE_H
...
namespace Exchange {
    ...
    inline std::string marketUpdateTypeToString(MarketUpdateType type) {
        ...
        ///these structures go over the wire  / network , so the binary structure are packed to remove system extra padding

#pragma pack(push , 1)
///// Market update structure used internally by the atching engine
...
#endif //MARKET_MATCHING_TRADING_SERVER_CPP_MARKET_UPDATE_H
